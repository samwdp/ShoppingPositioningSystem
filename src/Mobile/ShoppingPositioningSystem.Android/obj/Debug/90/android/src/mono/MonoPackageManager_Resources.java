...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ShoppingPositioningSystem.Android.dll" comes first in this list. */
		"ShoppingPositioningSystem.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"ShoppingPositioningSystem.dll",
